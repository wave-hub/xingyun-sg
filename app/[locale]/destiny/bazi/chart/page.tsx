...
import BaziChart from "@/components/destiny/bazi/BaziChart";
        ...
        <div className="container-brand max-w-4xl mx-auto text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            <div className="inline-flex items-center gap-2 mb-4">
              ...
              <span className="text-amber-400 text-sm font-english">FREE BA ZI CHART</span>
            </div>
            ...
            {!chartGenerated ? (
              ...
              <motion.div key="chart" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }}>
                ...
                <div className="text-center mt-8 space-y-4">
                  <p className="text-neutral-400 text-sm">想要深入了解您的八字？讓 AI 為您詳細分析</p>
                  <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                    <Link href="/destiny/bazi/ai-reading">
                      <Button variant="primary" size="lg">AI 解讀八字</Button>
                    </Link>
